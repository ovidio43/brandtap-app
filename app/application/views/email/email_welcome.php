...
<title>Welcome to Brand Tap</title>
<style type="text/css">
td {
...
<body bgcolor="#F3F3F3" style="margin:0px;">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" bgcolor="#F3F3F3"><table width="600" border="0" cellspacing="0" cellpadding="0" style="border:1px #CCC solid;">
        <tr>
          <td align="center" bgcolor="#FFFFFF"><img src="<?=base_url()?>img/welcome_email_img/banner.png" width="600" height="200" alt="" /></td>
        </tr>
        <tr>
          <td height="25" bgcolor="#FFFFFF">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF"><table width="560" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top"><span style="font-size:18px; line-height:22px;">You can now send customized emails straight to your followers anytime they like or comment on your posts! Build your database of emails while easily connecting to your fans.</span><br />
                  <br />
                  <span style="color:#DF0006;">How to get the most from Brand Tap? </span><br />
                  <ul>
                    <li>Provide a Customized Coupon Code</li>
                    <li>Create a Custom Video</li>
                    <li>Send a Checkout Button to Buy Your Product Now</li>
                    <li>Give Exclusive Access</li>
                    <li>Send out a Recipe</li>
                    <li>Add Product to a Shopping Cart</li>
                  ...
                  <br />
                  Do you need help setting up your campaigns? How can I grow my Instagram account using BrandTap?<br />
                  <br />
                  <strong>Email us at:</strong> <a href="mailto:info@brandtap.it" target="_blank" style="color:#df0209;">info@brandtap.it</a> for Anything! <br />
                  <br />
                  Thanks and please spread the word! <br />
                  <br />
                  The Brand Tap Team</td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="55%" style="font-size:12px;">Copyright © 2015 BRANDTAP. All rights reserved</td>
                      <td width="45%" align="right" valign="top"><table width="90" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="30"><a href="http://instagram.com/brand_tap" target="_blank"><img src="<?=base_url()?>img/welcome_email_img/instagram.png" width="30" height="29" alt="instagram" /></a></td>
                            <td width="20">&nbsp;</td>
                            <td width="30"><a href="https://twitter.com/BrandTap_" target="_blank"><img src="<?=base_url()?>img/welcome_email_img/twitter.png" alt="Twitter" width="34" height="27" /></a></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
